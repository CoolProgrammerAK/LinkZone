...
import { signUp, logInwithgoogle,logInwithfacebook } from "../redux/actions/useraction";
      ...
      <MDBContainer fluid>
            ...
            <MDBCard className="mx-auto my-2"  style={{ minWidth: 250,maxWidth:600}}>
              ...
              <MDBModalFooter className="mx-5 pt-3 mb-1 text-center">
                ...
                >
                  Already a member?{" "}
                  <Link to="/login" className="blue-text ml-1" style={{textDecoration:'underline'}}>
                    {" "}
                    <b>Sign In</b> 
                  </Link>
                </p>
...
export default connect(mapstatetoprops, { signUp, logInwithgoogle,logInwithfacebook })(signup);
